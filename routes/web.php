...
Route::middleware(['auth'])->group(function() {
    ...
    Route::get('/reports/generate/{module}', [ReportController::class, 'generate'])->name('reports.generate');
    Route::get('/reports/data/{module}', [ReportController::class, 'data'])->name('reports.data');
    Route::get('/reports/{module}', [ReportController::class, 'index'])->name('reports.index');
