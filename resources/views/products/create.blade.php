...
<div class="container page-header">
    <div class="row">
        <div class="col-6 d-flex align-items-center justify-content-start">
            <h3><span class="header-title">New Product</span></h3>
        </div>
    ...
    <form class="needs-validation" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <fieldset class="form-fieldset row">
            ...
            <div class="col-lg-3 my-3">
                ...
                <input id="stock" name="stock" type="number" min="0" step="0.01" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock') }}"/>
            </div>
            <div class="col-lg-3 my-3">
